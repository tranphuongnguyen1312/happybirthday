$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Hãy làm một chiếc bánh của chính bạn!','Nay là sinh nhật của Minh Thư nên minh thư sẽ tự tay làm chiếc bánh sinh nhật như 1 món quà.');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Đã trộn xong','Hỗn hợp bạn trộn rất tuyết vời rất mềm mịn.');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Đã nướng xong','Thật tuyệt bạn đúng là một đầu bếp tuyệt vời nhưng thật nghiệp dư');
    }
})
